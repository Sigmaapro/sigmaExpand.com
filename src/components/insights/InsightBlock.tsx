...
import { localeEyebrow } from "@/lib/localeTypography";
...
export function InsightBlock({ content }: { content: string }) {
  ...
  return (
    ...
    >
      ...
      />
      <p
        className={`font-display text-[11px] font-semibold uppercase tracking-[0.2em] text-[#bde0fe] ${localeEyebrow(language)}`}
      >
