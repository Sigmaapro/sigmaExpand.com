  ...
  return (
    <header className="border-b border-white/[0.06] px-3 pb-8 pt-6 sm:px-6 sm:pb-12 sm:pt-10 lg:px-10">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="font-display mt-6 text-2xl font-semibold uppercase leading-[1.1] tracking-tight text-[#f8f9fa] text-balance sm:mt-8 sm:text-4xl md:text-5xl">
          {post.title}
        </h1>
        <p className="mt-4 text-base leading-relaxed text-[#ced4da] text-pretty sm:mt-6 sm:text-lg md:text-xl">
          {post.intro}
        </p>
        <div className="mt-6 flex flex-col gap-2 text-[10px] uppercase tracking-[0.14em] text-[#868e96] sm:mt-8 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 sm:text-[11px] md:gap-4">
