...
import { insightsListingCopy } from "@/content/insights";
import { siteRestByLang } from "@/content/site";

export function InsightsChrome() {
  const nav = siteRestByLang.EN.nav;
  return (
