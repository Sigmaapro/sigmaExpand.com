 ...
 * Same horizontal curve on all viewports; narrow screens scale via overflow.
 */
export function ServiceConversionFlow({ title, body }: ServiceConversionFlowProps) {
  return (
    <ServiceSectionShell id="traffic-to-volume" atmosphere="violet">
      ...
      <div className="grid items-center gap-8 sm:gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)]">
        <p className="max-w-[46rem] text-[15px] leading-relaxed text-[#cfd6de] md:text-base">{body}</p>
        <div className="relative overflow-x-auto overflow-y-hidden rounded-2xl border border-white/[0.09] bg-[#05070c]/85 p-4 sm:overflow-hidden sm:p-6" aria-hidden="true">
          <svg viewBox="0 0 360 120" className="mx-auto h-auto w-full min-w-[17.5rem]">
            <defs>
