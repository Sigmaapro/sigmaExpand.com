...
export function MarketingHeader() {
  ...
  const contactHref = routePathForLang(ROUTES.contact, language);
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#07090f]/90 pt-[env(safe-area-inset-top,0px)] backdrop-blur-xl supports-[backdrop-filter]:bg-[#07090f]/75">
      <div className="mx-auto flex min-h-[4.25rem] max-w-[90rem] flex-nowrap items-center justify-between gap-2 px-3 sm:gap-4 sm:px-6 lg:px-10">
        <Link
          href={ROUTES.home}
          className="group flex min-w-0 shrink-0 items-center gap-2.5 text-[#c5ccd3] transition-colors hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#bde0fe]/55 rounded-sm"
        >
