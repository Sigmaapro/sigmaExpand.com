    ...
    <MarketingSubpageScaffold>
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        <header className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 text-sm leading-relaxed text-[#b6bcc4] md:text-base">{c.intro}</p>
        </header>
        ...
        <ul className="mt-14 grid gap-4 sm:grid-cols-2">
          {c.members.map((m) => (
            ...
            >
              ...
              <p className="mt-1 text-xs font-semibold uppercase tracking-[0.12em] text-[#1c39bb]">{m.role}</p>
