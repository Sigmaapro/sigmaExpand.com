...
export const contactSubpageContentByLang: Record<LangCode, ContactSubpageBody> = {
  EN: {
    ...
    form: {
      ...
      submit: "Send message",
      sending: "Sending…",
      success: "Thank you. Your message has been received. The Sigma team will get back to you.",
  ...
  FA: {
    ...
    form: {
      ...
      success: "ممنون. پیام شما دریافت شد. تیم Sigma با شما تماس می‌گیرد.",
      requiredFieldError: "این فیلد الزامی است.",
      validationError: "ایمیل و پیام را وارد کنید.",
      invalidEmailError: "لطفاً یک ایمیل معتبر وارد کنید.",
      sendError: "مشکلی پیش آمد. لطفاً دوباره تلاش کنید یا مستقیم با BD@sigmaa.pro تماس بگیرید.",
    },
    social: { title: "ارتباط" },
  },
  ZH: {
  ...
  ES: {
    ...
    form: {
      ...
      submit: "Enviar",
      sending: "Enviando…",
      success: "Gracias. Hemos recibido tu mensaje. El equipo de Sigma se pondrá en contacto contigo.",
      requiredFieldError: "Este campo es obligatorio.",
      validationError: "Introduce correo y mensaje.",
      invalidEmailError: "Introduce un email válido.",
      sendError: "Algo salió mal. Inténtalo de nuevo o contacta directamente con BD@sigmaa.pro.",
    },
  ...
  RU: {
    ...
    form: {
      ...
      submit: "Отправить",
      sending: "Отправка…",
      success: "Спасибо. Ваше сообщение получено. Команда Sigma свяжется с вами.",
      ...
      sendError: "Что-то пошло не так. Попробуйте ещё раз или свяжитесь напрямую с BD@sigmaa.pro.",
    },
    social: { title: "Связь" },
  },
  AR: {
    ...
    form: {
      ...
      success: "شكرًا لك. تم استلام رسالتك. سيقوم فريق Sigma بالتواصل معك.",
      ...
      sendError: "حدث خطأ ما. يرجى المحاولة مرة أخرى أو التواصل مباشرة عبر BD@sigmaa.pro.",
    },
    social: { title: "تواصل" },
  },
};
