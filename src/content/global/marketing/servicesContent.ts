...
export const servicesPageMetaByLang: Record<LangCode, PageMeta> = {
  ...
  AR: {
    title: "الخدمات",
    description:
      "اكتشف قدرات سيغما الأساسية: برامج السيولة، طبقات المخاطر والامتثال، التكامل التقني، وتنفيذ النمو الأصلي في Web3.",
  },
};
...
export const servicesPageContentByLang: Record<LangCode, ServicesMarketingBody> = {
  ...
  AR: {
    kicker: "القدرات",
    headline: "كل ما تحتاجه للتوسّع بثقة",
    intro:
      "يجمع كل تعاون بين الاستراتيجية والتنفيذ والقياس. فيما يلي هيكلنا النموذجي — تُخصَّص خارطة الطريق أثناء الانضمام.",
    sections: [
      {
        id: "liquidity",
        eyebrow: "الأسواق",
        title: "السيولة وهيكل السوق",
        description:
          "تصميم وتشغيل برامج سيولة تظل مرنة عبر المراحل — من الإطلاق إلى أسواق ثنائية الجانب ناضجة.",
        bullets: [
          "تصميم مخزون وحوافز متوافقة مع أهداف عمق التداول الحقيقية",
          "تنسيق الشركاء بين صناع السوق والمنصّات والمكاتب الداخلية",
          "أدلة تشغيلية لسيناريوهات الضغط والإدراج والحملات المنسّقة",
        ],
      },
      {
        id: "risk",
        eyebrow: "الثقة",
        title: "المخاطر والامتثال والمراقبة",
        description:
          "انضباط تشغيلي يرضي الأطراف دون إبطاء وتيرة المنتج.",
        bullets: [
          "أطر ضبط تتوافق مع الاختصاص القضائي ومزيج الطرف المقابل",
          "خطافات مراقبة فورية ومسارات تصعيد يمكن لفريقك امتلاكها",
          "حزم توثيق مناسبة للشركاء والمراجعين المؤسسيين",
        ],
      },
      {
        id: "integration",
        eyebrow: "الهندسة",
        title: "التكامل التقني وواجهات API",
        description:
          "موصلات، خطوط بيانات، وتحسينات موثوقية إلى جانب حركة الوصول للسوق.",
        bullets: [
          "أنماط تكامل API-first مع مؤشرات خدمة واضحة حيث يهمّ الأمر",
          "تعاون مع فريق الهندسة عبر البيئات التجريبية والإنتاج",
          "أدلة تشغيل ومراقبة لتقليل الحوادث وتسهيل الاسترداد",
        ],
      },
      {
        id: "growth",
        eyebrow: "التوزيع",
        title: "النمو الأصلي في Web3 والشراكات",
        description:
          "توزيع يحترم أعراف المجتمع مع أهداف قابلة للقياس للاكتساس والاحتفاظ.",
        bullets: [
          "هندسة حملات تمتد بين صنّاع المحتوى والمجتمعات والقنوات المؤسسية",
          "أنظمة إبداع ورسائل متسقة مع العلامة عبر الأسواق",
          "إسناد وقياس قمع مرتبط بمؤشراتكم الأساسية",
        ],
      },
    ],
  },
